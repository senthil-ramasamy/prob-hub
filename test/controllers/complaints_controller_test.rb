...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { cactionseq: @complaint.cactionseq, cfield: @complaint.cfield, cid: @complaint.cid, cpersonal: @complaint.cpersonal, ctext: @complaint.ctext, ifprivate: @complaint.ifprivate }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { cactionseq: @complaint.cactionseq, cfield: @complaint.cfield, cid: @complaint.cid, cpersonal: @complaint.cpersonal, ctext: @complaint.ctext, ifprivate: @complaint.ifprivate }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
